...
export const et: Messages = {
  ...
  profile: {
    ...
    email: "E-post",
    phone: "Telefon",
    positionMissing: "Amet määramata",
    active: "Aktiivne",
    inactive: "Mitteaktiivne",
    currentObject: "Praegune objekt",
    noObject: "Objekt määramata",
    since: "Alates {{date}}",
    assignmentHistory: "Tööajalugu",
    noHistory: "Määramiste ajalugu veel puudub.",
    unknownObject: "Tundmatu objekt",
    current: "Praegune",
    present: "praeguseni",
  },
  settings: {
