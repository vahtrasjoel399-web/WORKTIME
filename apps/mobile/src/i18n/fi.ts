...
export const fi: Messages = {
  ...
  profile: {
    ...
    email: "Sähköposti",
    phone: "Puhelin",
    positionMissing: "Tehtävää ei määritetty",
    active: "Aktiivinen",
    inactive: "Ei aktiivinen",
    currentObject: "Nykyinen kohde",
    noObject: "Kohdetta ei ole määritetty",
    since: "Alkaen {{date}}",
    assignmentHistory: "Työhistoria",
    noHistory: "Kohdehistoriaa ei vielä ole.",
    unknownObject: "Tuntematon kohde",
    current: "Nykyinen",
    present: "nykyhetkeen",
  },
  settings: {
