...
export const dict: Dict = {
  ...
  // admin navigation
  navWorkers: { et: "Töötajad", ru: "Сотрудники", en: "Employees" },
  navTeam: { et: "Tiim", ru: "Команда", en: "Team" },
  navMap: { et: "Elav kaart", ru: "Карта", en: "Live map" },
  navMapShort: { et: "Kaart", ru: "Карта", en: "Map" },
  navReports: { et: "Aruanded", ru: "Отчёты", en: "Reports" },
  navReportShort: { et: "Aruanne", ru: "Отчёт", en: "Report" },
  navSites: { et: "Objektid", ru: "Объекты", en: "Sites" },
  switchTheme: { et: "Vaheta teemat", ru: "Сменить тему", en: "Switch theme" },
  workforceOverview: { et: "Tööjõu ülevaade", ru: "Обзор персонала", en: "Workforce overview" },
  employees: { et: "Töötajad", ru: "Сотрудники", en: "Employees" },
  weeklyReport: { et: "Nädala aruanne", ru: "Недельный отчёт", en: "Weekly report" },
  addUser: { et: "Lisa kasutaja", ru: "Добавить пользователя", en: "Add user" },
  employeeCount: { et: "Töötajaid", ru: "Сотрудников", en: "Employees" },
  workingNow: { et: "Praegu tööl", ru: "Сейчас на работе", en: "Working now" },
  weeklyHours: { et: "Nädala tööaeg", ru: "Часы за неделю", en: "Weekly hours" },
  weeklyPayroll: { et: "Nädala palgafond", ru: "Фонд за неделю", en: "Weekly payroll" },
  estimatedGross: { et: "Bruto, hinnanguline", ru: "Брутто, ориентировочно", en: "Estimated gross" },
  searchEmployee: { et: "Otsi töötajat", ru: "Найти сотрудника", en: "Search employees" },
  searchEmployeeHint: { et: "Otsi nime, ameti, telefoni, e-posti või objekti järgi", ru: "Поиск по имени, должности, телефону, почте или объекту", en: "Search by name, role, phone, email, or site" },
  status: { et: "Staatus", ru: "Статус", en: "Status" },
  all: { et: "Kõik", ru: "Все", en: "All" },
  activePlural: { et: "Aktiivsed", ru: "Активные", en: "Active" },
  inactivePlural: { et: "Mitteaktiivsed", ru: "Неактивные", en: "Inactive" },
  employee: { et: "Töötaja", ru: "Сотрудник", en: "Employee" },
  contact: { et: "Kontakt", ru: "Контакты", en: "Contact" },
  currentSite: { et: "Praegune objekt", ru: "Текущий объект", en: "Current site" },
  week: { et: "Nädal", ru: "Неделя", en: "Week" },
  rate: { et: "Hind", ru: "Ставка", en: "Rate" },
  reportsPayroll: { et: "Palgaarvestus", ru: "Расчёт зарплаты", en: "Payroll" },
  workReport: { et: "Tööaruanne", ru: "Отчёт по работе", en: "Work report" },
  previousWeek: { et: "← Eelmine nädal", ru: "← Предыдущая неделя", en: "← Previous week" },
  currentWeek: { et: "See nädal", ru: "Эта неделя", en: "This week" },
  nextWeek: { et: "Järgmine nädal →", ru: "Следующая неделя →", en: "Next week →" },
  lastFourWeeks: { et: "Viimased 4 nädalat", ru: "Последние 4 недели", en: "Last 4 weeks" },
  hoursInPeriod: { et: "Tunnid perioodis", ru: "Часы за период", en: "Hours in period" },
  payroll: { et: "Palgafond", ru: "Фонд оплаты", en: "Payroll" },
  employeesWithTime: { et: "Töötajaid tööajaga", ru: "Сотрудников с часами", en: "Employees with hours" },
  from: { et: "Alates", ru: "С", en: "From" },
  to: { et: "Kuni", ru: "По", en: "To" },
  showPeriod: { et: "Näita perioodi", ru: "Показать период", en: "Show period" },
  total: { et: "Kokku", ru: "Итого", en: "Total" },
  earned: { et: "Teenitud", ru: "Начислено", en: "Earned" },
  userRole: { et: "Roll", ru: "Роль", en: "Role" },
  accountant: { et: "Raamatupidaja", ru: "Бухгалтер", en: "Accountant" },
  workerAccess: { et: "Vahetused ja tööaeg", ru: "Смены и рабочее время", en: "Shifts and work time" },
  accountantAccess: { et: "Ainult töötajad ja aruanded", ru: "Только сотрудники и отчёты", en: "Employees and reports only" },
  temporaryPassword: { et: "Ajutine parool", ru: "Временный пароль", en: "Temporary password" },
  createAccount: { et: "Loo konto", ru: "Создать аккаунт", en: "Create account" },
  cancel: { et: "Tühista", ru: "Отмена", en: "Cancel" },
  ...
  accountNotFound: { et: "Selle e-postiga WorkTime’i kontot ei leitud.", ru: "Аккаунт WorkTime с такой почтой не существует.", en: "No WorkTime account exists with this email." },
  resetFailed: { et: "Taastamislinki ei õnnestunud saata. Proovi hiljem uuesti.", ru: "Не удалось отправить ссылку восстановления. Попробуйте позже.", en: "Could not send the recovery link. Try again later." },
  resetRateLimited: { et: "Liiga palju taastamiskatseid. Proovi mõne minuti pärast uuesti.", ru: "Слишком много запросов. Попробуйте снова через несколько минут.", en: "Too many requests. Try again in a few minutes." },
